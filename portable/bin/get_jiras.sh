...
jira --project RADIO --min 17992 --max 30061 --no-forward --format raw >> ~/.jiras/RADIO.jsonl
#jira --project CATALOG --max 3374 --no-forward --format raw >> ~/.jiras/CATALOG.jsonl
#jira --project CONTIN --max 12295 --no-forward --format raw >> ~/.jiras/CONTIN.jsonl
